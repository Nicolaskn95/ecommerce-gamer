...
export default function UsersReviews(props: AvaliacoesUsuariosProps) {
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex items-center gap-5 mt-5">
        <div className="flex flex-col gap-2 items-center">
          <div className="text-7xl text-pink-600">{props.product.grade}</div>
          <GradeReview grade={props.product.grade} size={18} />
